      ...
      <footer style={theme.footer}>
        <section style={theme.sitemap}>
          <div style={theme.sitemapSection}>
            ...
            <a style={theme.sitemapSectionRow} href={site.docUrl('installation')}>Getting Started</a>
            <a style={theme.sitemapSectionRow} href={site.docUrl('guide_logger')}>Guides</a>
          </div>
          <div style={theme.sitemapSection}>
          ...
          <div style={theme.sitemapSection}>
            ...
            <a style={theme.sitemapSectionRow} href="https://github.com/richardzcode/fsts-js">GitHub</a>
          </div>
        </section>
